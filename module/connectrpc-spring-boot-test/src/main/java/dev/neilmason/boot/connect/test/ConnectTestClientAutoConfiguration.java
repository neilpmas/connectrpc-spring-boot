...
import dev.neilmason.boot.connect.ConnectProperties;
...
public class ConnectTestClientAutoConfiguration {

	@Bean
	@ConditionalOnMissingBean
	public ConnectTestClient connectTestClient(WebTestClient webTestClient, ConnectProperties connectProperties) {
		return new ConnectTestClient(webTestClient, connectProperties.getPathPrefix());
	}
